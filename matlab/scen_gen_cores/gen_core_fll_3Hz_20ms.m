...
Description = ...
    'Сценарий работы системы частотной автоподстройки при qcno от 55 до 0 дБГц, а stdn_IQ=8, период накопления в корреляторах 1 мс, символьная синхронизация есть, полоса ЧАП 3Гц';
filename = 'FLL3Hz-55to0dBHz-stdnIQ_8-T_1ms-Sync20.mat';
disp('gen_core_fll_3Hz_20ms started');
