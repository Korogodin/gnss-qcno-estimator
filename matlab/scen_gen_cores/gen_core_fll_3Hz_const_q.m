...
Description = ...
    'Сценарий работы системы частотной автоподстройки при qcno 25 дБГц, а stdn_IQ=8, период накопления в корреляторах 1 мс, символьной синхронизации нет, полоса ЧАП 3Гц';
filename = 'FLL3Hz-25dBHz-stdnIQ_8-T_1ms-NoSync.mat';
