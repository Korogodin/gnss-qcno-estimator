...
typedef struct {
	...
	quint32 x_A_est; ///< Сдвинутая оценка амплитуды 1мс квадратур
	quint32 x_A2_est; ///< Сдвинутая оценка квадрата амплитуды базовых корр. сумм
	quint8 	x_A2_shift; ///< Её сдвиг

	quint32 A_IQ_2_est; ///< Оценка квадрата амплитуды 1мс квадратур
	quint32 stdn_IQ_2_est; ///< Оценка квадрата амплитуды 1мс квадратур
	...
	qint8 fail_counter; ///< Счетчик подряд идущих оценок амплитуды <= 0
