...
Description = ...
    'Сценарий работы системы частотной автоподстройки при qcno от 45 до 0 дБГц, а stdn_IQ=8, период накопления в корреляторах 1 мс, символьной синхронизации нет, полоса ЧАП 0.1Гц';
filename = 'FLL01Hz-45to0dBHz-stdnIQ_8-T_1ms-NoSync.mat';
disp('gen_core_fll_01Hz started');

global TauChip; 
TauChip = 300;

Tmod = 100; % Время моделирования
