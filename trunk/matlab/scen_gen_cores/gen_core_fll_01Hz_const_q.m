...
Description = ...
    'Сценарий работы системы частотной автоподстройки при qcno 15 дБГц, а stdn_IQ=8, период накопления в корреляторах 1 мс, символьной синхронизации нет, полоса ЧАП 0.1Гц';
filename = 'FLL01Hz-15dBHz-stdnIQ_8-T_1ms-NoSync.mat';
